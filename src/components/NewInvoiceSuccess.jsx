...
function NewInvoiceSuccess({ user }) {
    ...
    <div className="flex bg-gray-50 h-screen">
      ...
      >
        ...
        <main className="flex-1 flex items-center justify-center px-4 py-6 overflow-y-auto bg-gray-50">
          <div className="relative bg-white w-full max-w-[618px] min-h-[561px] rounded-xl shadow-md flex flex-col items-center justify-center p-6 text-center">
...
export default NewInvoiceSuccess;
