...
const Wallet = () => {
  ...
  const [walletData, setWalletData] = useState({
    ...
    expenses: 950,
    transactions: [
      { id: 1, type: "Credit", amount: 500, date: "2025-10-06", status: "Successful" },
      { id: 2, type: "Debit", amount: 200, date: "2025-10-05", status: "Successful" },
      { id: 3, type: "Credit", amount: 1000, date: "2025-10-04", status: "Pending" },
      { id: 4, type: "Debit", amount: 150, date: "2025-10-03", status: "Failed" },
      { id: 5, type: "Credit", amount: 300, date: "2025-10-02", status: "Successful" },
    ],
  });

  const availableCurrencies = [
    { country: "United States", currency: "USD", symbol: "$", flag: "/src/assets/usd.svg" },
    { country: "United Kingdom", currency: "GBP", symbol: "£", flag: "/src/assets/gbp.svg" },
    { country: "European Union", currency: "EUR", symbol: "€", flag: "/src/assets/eur.svg" },
  ];
      ...
      >
        ...
        <main className="flex-1 overflow-y-auto p-6 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white shadow-md rounded-xl p-6 flex flex-col justify-between">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <p className="text-gray-700 font-semibold">{walletData.country}</p>
              ...
              <div className="text-center my-6">
                <h2 className="text-4xl font-bold text-gray-800 mb-2">
                  {showBalance
                    ? `${walletData.symbol}${walletData.balance.toLocaleString()}`
                    : "•••••••"}
                </h2>
            ...
            <div className="bg-white shadow-md rounded-xl p-6 flex flex-col justify-between">
              <h3 className="text-gray-800 font-semibold mb-4">Receiving Account</h3>
              <div className="space-y-4 flex-1">
                {Object.entries(walletData.receivingAccount).map(([key, value]) => (
            ...
            <div className="bg-white shadow-md rounded-xl p-6 flex flex-col justify-between">
              <h3 className="text-gray-800 font-semibold mb-4">Expenses Overview</h3>
              <div className="flex justify-between items-center mb-2">
                <div>
                  <p className="text-sm text-gray-500">Income</p>
                  <h2 className="text-2xl font-bold text-green-600">
                    {walletData.symbol}{walletData.income.toLocaleString()}
                  </h2>
                </div>
                <div>
                  <p className="text-sm text-gray-500 text-right">Expenses</p>
                  <h2 className="text-2xl font-bold text-red-500 text-right">
                    {walletData.symbol}{walletData.expenses.toLocaleString()}
                  </h2>
                </div>
              </div>
            </div>
                  ...
                  {walletData.transactions.map((tx) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-4 text-gray-500">
                        {walletData.symbol}{tx.amount.toLocaleString()}
                      </td>
              ...
              {availableCurrencies.map((currency) => (
                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    <p className="text-gray-800 font-medium">{currency.country}</p>
